...
You will need to obtain an API key and data URL from [Anomify AI](https://anomify.ai/) before the plugin can be enabled. Anomify has a free Developer account which allows up to 100 metrics.
